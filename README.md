Jwt Authentication without ASP.NET Core Identity 3.1.102
===========

![jwtauth](/src/ASPNETCore2JwtAuthentication.WebApp/wwwroot/images/jwtauth.png)

A Jwt based authentication sample for ASP.NET Core 3.1.102 without using the Identity system. It includes:
